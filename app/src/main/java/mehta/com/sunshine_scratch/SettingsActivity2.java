...
public class SettingsActivity2 extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || TemperaturePreferenceFragment.class.getName().equals(fragmentName);
    }

    /**
     * This fragment shows location preferences.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    ...
    /**
     * This fragment shows temperature preferences.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class TemperaturePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
